...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        ...
        case kFeatureRequests: {
            [OBAAnalytics reportEvent:@"ui_action" action:@"button_press" label:@"Clicked Feature Request Link" value:nil];
        ...
        case kPrivacy: {
            [OBAAnalytics reportEvent:@"ui_action" action:@"button_press" label:@"Clicked Privacy Policy Link" value:nil];
